...
public class BTree<T extends Comparable<T>> {
    ...
    public void insert(T value) {
        if (root == null) {
            ...
            element[0]="insert";
        	element[1]=root;
        	element[2]=root.getValuePosition(value);
        } else {
        	int pop_counter=0;
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                    ...
                    element[0]=currentNode;
                    element[1]=currentNode.indexOf(median_value);
                    stack.push(element);
                ...
                if (currentNode.isLeaf()) {
                	...
                	element[2]=currentNode.getValuePosition(value);
                	element[3]=pop_counter;
                	wasAdded = true;
                } else {
                    int idx = currentNode.getValuePosition(value);
                    currentNode = currentNode.getChild(idx);

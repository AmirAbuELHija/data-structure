...
//            root.addKey(value);
//            //-----------------------------------------
//            Object[] insert_action = new Object[3];
//            insert_action[0] = "insert";
//            insert_action[1] = value;
//            insert_action[2] = 0;
//     
//            stack.addFirst(insert_action);
//
//        } else {
//        	//----------------------------------------
//        	int pop_counter = 0;
...
//                	T median_value = split(currentNode);
//                    Object[] split_action = new Object[2];
//                	// Return to the parent and descend to the needed node
//                	currentNode = currentNode.parent != null ? currentNode.parent : root;
//                	split_action[0] = median_value;
//                	split_action[1] = currentNode.getValuePosition(median_value);
//                    stack.addFirst(split_action);
...
public class BTree<T extends Comparable<T>> {
    ...
    public void insert(T value) {
        if (root == null) {
            ...
            root.addKey(value);
            //-----------------------------------------
            Object[] insert_action = new Object[4];
            insert_action[0] = "insert";
            insert_action[1] = root;
            insert_action[2] = value;
            insert_action[3] = 0;
            stack.addFirst(insert_action);
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.getNumberOfKeys() == maxDegree - 1) {
                	//----------------------------------------
                    Object[] split_action = new Object[3];
                    T median_value = split(currentNode);
                	// Return to the parent and descend to the needed node
                    Node<T> wanted_node=currentNode;
                	split_action[0] = median_value;
                	split_action[2] = wanted_node;
                ...
                if (currentNode.isLeaf()) {
                	...
                	Object[] insert_action = new Object[4];
                	insert_action[0] = "insert";
                	insert_action[1] = currentNode;
                	insert_action[2] = value;
                	insert_action[3] = pop_counter;
                	stack.addFirst(insert_action);
                	//-----------------------------------
                	wasAdded = true;
                } else {
